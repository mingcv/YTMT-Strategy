    ...
    def eval(self, data, savedir=None, suffix=None, pieapp=None):
        ...
        with torch.no_grad():
            ...
            if self.aligned:
                ...
                res2 = index.quality_assess(out_l2, target)
...
class TwoStageYTMTNetModel(YTMTNetBase):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self._init_optimizer([self.optimizer_G2])
    ...
    def get_loss(self, out_l, out_r):
        ...
        loss_rcnn_vgg = self.loss_dic['r_vgg'].get_loss(out_r, self.target_r) * self.opt.lambda_vgg * 0.2
    ...
    def backward_G(self):
        ...
        self.loss_icnn_vgg = self.get_loss(self.output_i_stage2, self.output_j_stage2)

        self.loss_exclu = self.exclusion_loss(self.output_i_stage2, self.output_j_stage2, 3)

        self.loss_recons = self.loss_dic['recons'](self.output_i_stage2, self.output_j_stage2, self.input) * 0.4
    ...
    def _forward_stage1(self):
        # without edge
        input_i = self.input
        output_i, output_j = self.net_i1(self.hyper_column(input_i), fn=self.data_name[0] if self.data_name else None)
    ...
    def get_current_errors(self):
        ...
        ret_errors['lr'] = self.optimizer_G2.param_groups[0]['lr']
